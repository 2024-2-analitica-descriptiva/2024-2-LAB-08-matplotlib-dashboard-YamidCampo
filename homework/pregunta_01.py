...
def pregunta_01():
    """
    El archivo `files//shipping-copia.csv` contiene información sobre los envios
    ...
    * El archivo de datos se encuentra en la carpeta `copia`.
    ...
    * Su código debe crear la carpeta `docs` si no existe.
    ...
    # Lectura datos y creacíon base datos
